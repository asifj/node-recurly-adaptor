(function(){
  ...
  module.exports = function(config){
		...
		//add additional info to the config object, fixed by aj
    ...
    this.invoices = {
      ...
      getPDF: function(invoiceid, callback){
        t.request('/invoices/' + invoiceid, 'GET', callback, 100000, 'application/pdf');
      },
